...
const ROOT_URL = 'https://api-merchant.vimo.vn/checkout.php';
...
class Vimo {
	...
	GetBalanceUserLinked(options, cb) {
	...
	CheckTransactionByToken(options, cb) {
